    ...
    , ui(new Ui::MainWindow)
{
    ...
    cardSize_.setWidth(screenGeometry.width() * 0.7 / columns_);
    cardSize_.setHeight(screenGeometry.height() * 0.95 / rows_);
...
void MainWindow::openSettings()
{
    ...
    connect(settingWindow, &Settings::graphicsType, [this](int type) { graphicsType_ = type;});
    connect(settingWindow, &Settings::closeWindow, this, &MainWindow::deleteLater);
    settingWindow->show();
}
